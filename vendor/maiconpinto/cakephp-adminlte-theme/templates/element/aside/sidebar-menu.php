<ul class="sidebar-menu" data-widget="tree">
  ...
  <?php if ($authUser): ?>
    <li>
        <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'dashboard', $authUser['id']]); ?>">
    ...
    <li>
    <a href="<?php echo $this->Url->build('/tests'); ?>">
      <i class="fa fa-puzzle-piece"></i> <span>Tests</span>
      <span class="pull-right-container">
        <i class="fa fa-unlock pull-right"></i>
      </span>
    </a>
    ...
    <li>
    <a href="<?php echo $this->Url->build('/quetions'); ?>">
      <i class="fa fa-question-circle"></i> <span>Quetions</span>
      <span class="pull-right-container">
        <i class="fa fa-unlock pull-right"></i>
      </span>
    </a>
    ...
    <li>
    <a href="<?php echo $this->Url->build('/quetions-details'); ?>">
      <i class="fa fa-list-alt"></i> <span>Quetions Details</span>
      <span class="pull-right-container">
        <i class="fa fa-unlock pull-right"></i>
      </span>
    </a>
    ...
    <li>
    <a href="<?php echo $this->Url->build('/available-options-values'); ?>">
      <i class="fa fa-list-ul"></i> <span>All Options</span>
      <span class="pull-right-container">
        <i class="fa fa-unlock pull-right"></i>
      </span>
    </a>
    ...
    <li>
    <a href="<?php echo $this->Url->build('/tests-details'); ?>">
      <i class="fa fa-list-ul"></i> <span>Tests Details</span>
      <span class="pull-right-container">
        <i class="fa fa-unlock pull-right"></i>
      </span>
    </a>
